...
//         I.click('Home');
//         I.click('Chat');
//         I.see(locate(`.addedGroup${groupName}`).withText(groupName)); //checks that we have the new group added under the right section
//     })
// });
...
Scenario('Click on a chat group', ({I}) => {
    ...
    I.click('.sendAirplane'); //sends the message
    I.wait(2);
});